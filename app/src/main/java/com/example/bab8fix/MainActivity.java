package com.example.bab8fix;

import static com.example.bab8fix.DBmain.TABLENAME;
...
import com.example.bab8fix.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertData() {binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
